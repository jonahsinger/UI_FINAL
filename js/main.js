...
function recordQuizAnswer(lessonNumber, isCorrect) {
    ...
    // We could track correct answers in session storage for the current quiz attempt
    if (isCorrect) {
...
// Reset all progress - This function is now handled directly in statistics.js
function resetProgress() {
    console.warn('This reset function is deprecated. The reset functionality is now handled in statistics.js');
